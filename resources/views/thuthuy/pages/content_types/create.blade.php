...
@section('title', 'Tạo mới thể loại nội dung')

@section('breadcrumb', 'Thể loại nội dung')

@section('content')
<div class="card pd-20 pd-sm-40">
    <h6 class="card-body-title">Tạo mới một thể loại của nội dung </h6>
    <div class="form-layout">
        <form action="{{ route('content-types.store') }}" method="post">
        ...
        @csrf
            ...
            <a href="{{ route('content-types.index') }}">
