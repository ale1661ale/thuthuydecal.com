...
@section('title', 'Tạo mới một thể loại hình ảnh')

@section('breadcrumb', 'Tạo mới thể loại')

@section('content')
<div class="card pd-20 pd-sm-40">
    <h6 class="card-body-title">Tạo mới một thể loại hình ảnh </h6>
    <div class="form-layout">

        <form action="{{ route('image-types.store') }}" method="post">
            ...
            <div class="form-layout-footer">
                ...
                <a href="{{ route('image-types.index') }}">
