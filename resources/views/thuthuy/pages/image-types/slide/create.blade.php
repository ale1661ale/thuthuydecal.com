...
@section('title', 'Tạo mới một slide')

@section('breadcrumb', 'Tạo mới slide')

@section('content')
<div class="card pd-20 pd-sm-40">
    <h6 class="card-body-title">Tạo mới một ảnh slide </h6>
            ...
            <div class="row mg-b-25">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="Nhập tên slide...">
                        @if($errors->has('name'))
